...
- Retrieval-evaluation corpus scale-up to `TESTING_STRATEGY.md`'s 30-60 note target (currently 10 notes/17 questions) — now unblocked to actually do
- Duplicate-detection default thresholds tuning against real vault data — now unblocked to actually do
